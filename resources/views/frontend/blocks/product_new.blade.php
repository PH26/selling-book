              ...
              <div class="owl-item" style="width: 210px;" data-id="{!! $product_new->id !!}">
                <div class="item">
                  <div class="product-item">
                    <div class="product-item-image"> <a href="{!! url('/'.$product_new->id) !!}">
                    <img class="img-responsive" src="{!! asset('upload/'.$product_new->image) !!}" > </a> </div>
                    <a class="product-item-name" href="{!! url('/'.$product_new->id) !!}">{!! $product_new->name !!}</a>
                    <div>
